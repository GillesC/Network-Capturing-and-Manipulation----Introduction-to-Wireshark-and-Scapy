...
11&2& DNS RPI server& Build your own DNS server with a Raspberry Pi.  \\
12&2& Ethical hacking & Study different open-source ethical hacking tools. Try to give some of them a try and present your findings with your colleagues\\
13&1 or 2& Matter& Investigate the Matter protocol.\\
\bottomrule
\end{tabular}%
%}
\end{table}
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item Send all your work in one \texttt{.zip} file including the code, slides and \textit{Q\,4} via e-mail. Use the naming format \verb|<firstname>_<lastname>.pdf| and \texttt{.zip} structure:
        \begin{itemize}
            \item \verb|ping.py|
            \item \verb|DNS.py|
            \item \verb|ARP.py|
            \item \verb|TCP.py|
            \item \verb|Q4.pdf|
            \item \verb|use-case.pdf| and (optional) \verb|use-case.ppt|
        \end{itemize}
     \end{itemize}
