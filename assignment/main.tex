...
\begin{versionhistory}
    ...
    \vhEntry{\currentversion}{09/11/2022}{GC}{Extended the tracerouting use case and removed explicitly mentioned that students need to communicate with their teaching assistant and not only me.}
\end{versionhistory}
\clearpage
