...
\vfill
{\footnotesize
This document is subjected to change, please consult the most recent version at: \url{Network-Capturing-and-Manipulation----Introduction-to-Wireshark-and-Scapy}.
}
